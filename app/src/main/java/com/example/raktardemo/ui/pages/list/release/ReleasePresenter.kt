...
class ReleasePresenter @Inject constructor(
    ...
    suspend fun onRelease(release: Release, item: StoredItem?, acqId: String?, group: List<StoredItem>): Unit = withIOContext {
        databaseInteractor.onRelease(release, item, acqId, group)
    }
}
